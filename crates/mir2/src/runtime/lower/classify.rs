...
use hir::analysis::{
    semantic::{
        ...
        borrowck::{
            ...
            NSTerminatorKind, NormalizedBindingLowering, NormalizedSemanticBody,
...
use super::{
    ...
    interface::{runtime_param_locals, runtime_param_plans},
    layout::{
...
pub(super) fn normalized_place_class_in_context<'db>(
    db: &'db dyn MirDb,
    body: &NormalizedSemanticBody<'db>,
    place: &NSPlace<'db>,
    carriers: &[RuntimeCarrier<'db>],
...
mod tests {
    ...
    use super::*;
    use crate::runtime::{
        lower::interface::runtime_visible_binding_plans, package::runtime_instance_for_semantic,
    };
