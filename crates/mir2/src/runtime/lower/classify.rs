...
use crate::{
    ...
    runtime::{
        ...
        RuntimeCarrier, RuntimeClass, RuntimeCodeRegion, RuntimeCodeRegionKey,
...
impl<'a, 'db> BodyEnv<'a, 'db> {
    ...
    pub(crate) fn with_carriers<'carriers>(
        self,
...
impl<'a, 'carriers, 'db> RuntimeBodyCx<'a, 'carriers, 'db> {
    ...
    pub(crate) fn expr_direct_class(
        ...
        self.env.expr_direct_class(self.carriers, expr, result_ty)
    }
